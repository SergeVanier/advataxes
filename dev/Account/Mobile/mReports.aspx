            ...
            <asp:GridView ID="gvExpenses" runat="server" 
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="63"  ItemStyle-Width="100px"  ItemStyle-ForeColor="black" ItemStyle-HorizontalAlign="Right">
                        <%--<ItemTemplate><asp:Label ID="Label1" runat="server" Text='<%# IIf(New List(Of String)(New String() {"taxi", "meals & entertainment", "km allowance", "meals & entertainment*", "meals & entertainment (work site + 30 km from a 40k urban area)"}).Contains(Eval("CAT_NAME").ToString().ToLower()), IIf(Eval("GRATUITIES") = 0, IIf(Eval("RATE") < 1, FormatNumber(Eval("AMOUNT") / Eval("RATE"), 0) & " x " & FormatNumber(Eval("RATE"), 2), ""), FormatNumber(Eval("GRATUITIES"), 2)), "")  %>'></asp:Label></ItemTemplate>--%>
                          <ItemTemplate><asp:Label ID="Label1" runat="server" Text='<%# IIf(Eval("ALLOW_KM") = True, IIf(Eval("GRATUITIES") = 0, IIf(Eval("RATE") < 1, FormatNumber(Eval("AMOUNT") / Eval("RATE"), 0) & " x " & FormatNumber(Eval("RATE"), 2), ""), FormatNumber(Eval("GRATUITIES"), 2)), "")  %>'></asp:Label></ItemTemplate>
                    </asp:TemplateField>
