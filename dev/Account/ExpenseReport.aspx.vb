...
Public Class Report1
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            s = ""
            Diagnostics.Trace.WriteLine(Request.QueryString("org"))
            ...
            If Session("emp").organization.id = orgID Or Session("emp").organization.parent.id = orgID Or orgID = 0 Then
                org = New Org(orgID)
                Diagnostics.Trace.WriteLine(Request.QueryString("type"))
    ...
    Private Sub CategoryReport()
        ...
        s += "<tr style='font-weight:bold;border-bottom:thin solid silver;border-top:thin solid silver;'><td>Rpt</td><td></td><td>" & GetMessage(78) & "</td><td>" & GetMessage(251) & "</td><td>" & GetMessage(60) & "<td align='left' >" & sName & "</td><td>Jur</td><td align='right' ><td>" & GetMessage(40) & "</td><td align='right' >" & GetMessage(45) & "</td><td align='right' >" & GetMessage(118) & "</td><td align='right' >" & GetMessage(119) & "</td>" & IIf(org.GSTReg And org.OrgSizeGST = 2, "<td align='right' >" & GetMessage(120) & "</td>", "") & "<td align='right' >Net</td><td align='right' >" & GetMessage(48) & "</td></tr>"
            ...
            For Each exp In org.Expenses
                ...
                If exp.OrgCategory.ID = orgCatID Or orgCatID = 0 Then
                    ...
                    If (exp.OrgCategory.Category.ID = 4) Then
                        ...
                        s += "<td align='right' width='8%'><td>" & FormatNumber(Amt, 2) & "</td>"
                    ...
                    Else
                        ...
                        s += "<td align='left' width='15%'>" & exp.Rpt.Emp.LastName & ", " & exp.Rpt.Emp.FirstName & "</td>"
                        s += "<td align='right' width='2%'>" & exp.Jurisdiction.Abbreviation & "</td>"
                        s += "<td align='right' width='8%'><td><td>" & FormatNumber(Amt, 2) & "</td>"
                        s += "<td align='right' width='8%'>" & FormatNumber(ITC, 2) & "</td>"
                        s += "<td align='right' width='8%'>" & FormatNumber(ITR, 2) & "</td>"
                        s += "<td align='right' width='8%' " & IIf(org.OrgSizeGST = 2 And org.GSTReg, "", "style='display:none;'") & ">" & FormatNumber(exp.RITC, 2) & "</td>"
                        s += "<td align='right' width='8%'>" & FormatNumber(Amt - ITC - ITR + exp.RITC, 2) & "</td>"
        ...
        If (orgCatID = 0) Then
            'If RITCTotalOnt > 0 Then s += "<tr style='font-weight:bold;'><td colspan='3' >Total " & GetMessage(250) & "</td><td><td></td><td " & IIf(orgCatID <> 0, "style='display:none;'", "") & "></td><td></td><td></td><td></td><td></td><td></td><td></td><td align='right' >" & FormatNumber(RITCTotalOnt, 2) & "</td><td></td><td></td></tr>"
            'If RITCTotalBC > 0 Then s += "<tr style='font-weight:bold;'><td colspan='3'>Total " & GetMessage(249) & "</td><td><td></td><td " & IIf(orgCatID <> 0, "style='display:none;'", "") & "></td><td></td><td></td><td></td><td></td><td></td><td align='right' >" & FormatNumber(RITCTotalBC, 2) & "</td><td></td><td></td></tr>"
            ' If RITCTotalPEI > 0 Then s += "<tr style='font-weight:bold;'><td colspan='3'>Total " & GetMessage(248) & "</td><td><td></td><td " & IIf(orgCatID <> 0, "style='display:none;'", "") & "></td><td></td><td></td><td></td><td></td><td></td><td></td><td align='right' >" & FormatNumber(RITCTotalPEI, 2) & "</td><td></td><td></td></tr>"
            '  s += "</table>"
        Else
            'If RITCTotalOnt > 0 Then s += "<tr style='font-weight:bold;'><td colspan='3' >Total " & GetMessage(250) & "</td><td><td></td><td " & "></td><td></td><td></td><td></td><td></td><td></td><td></td><td align='right' >" & FormatNumber(RITCTotalOnt, 2) & "</td><td></td><td></td></tr>"
            'If RITCTotalBC > 0 Then s += "<tr style='font-weight:bold;'><td colspan='3'>Total " & GetMessage(249) & "</td><td><td></td><td " & IIf(orgCatID <> 0, "style='display:none;'", "") & "></td><td></td><td></td><td></td><td></td><td align='right' >" & FormatNumber(RITCTotalBC, 2) & "</td><td></td><td></td></tr>"
            'If RITCTotalPEI > 0 Then s += "<tr style='font-weight:bold;'><td colspan='3'>Total " & GetMessage(248) & "</td><td><td></td><td " & IIf(orgCatID <> 0, "style='display:none;'", "") & "></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td align='right' >" & FormatNumber(RITCTotalPEI, 2) & "</td><td></td><td></td></tr>"
            ' s += "</table>"
        End If
