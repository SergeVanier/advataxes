...
<head>
	<meta charset="utf-8">
	<title>Live Demo | Advataxes</title>
	...
	<script runat="server" language="vb">
		Sub btnSend_Click(sender As Object, e As EventArgs)
			...
			returnValue = sendEmail(Me.txtEmail.Text, "Advataxes - Live Demo - " & txtName.Text, message)
...
<div class="col-md-12">
<div class="widget">
				<p>Use this contact form to register for a live demo on Advataxes, the employee expense software.</p>
			</div><!-- end widget -->
</div>
