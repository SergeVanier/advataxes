...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server"  > 
    ...
    <div>
       ...
       <div>
           ...
           <%
               Dim valid_categories As New List(Of String)(New String() {"taxi", "car"})
                    ...
                    <table width="95%" border=0>
                        ...
                        <tr id="Row-JurMsg">
                            ...
                            <tr  height="30px">
                                ...
                                <td align="left">
                                    <asp:TextBox ID="txtExpDate" Text="29/11/2017" runat="server" Width="100px" readonly="true"></asp:TextBox>                            
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td valign="middle">
                                    <asp:FileUpload ID="FileUpload1" runat="server" /><br />
                                     <span id="spnDocMsg" class="error" style="display: none;color:red"></span>
                                    <asp:Label ID="lblSelectedReceipt" runat="server" CssClass="labelText"></asp:Label>
            ...
            <div id="divSaveExpense" style="left:130px;top:-20px;width:95%">
                <table width="100%">
                    <tr>
                        <td>&nbsp;</td>
                        <td align="right" >                            
                            <asp:Button ID="cmdSaveExpense" runat="server" Text="140" tooltip="Save and close" CausesValidation="true" ValidationGroup="NewExpense" CssClass="button2"    OnClientClick="closeForm('modalCreateExpense')"/>
                    ...
                    $(document).ready(function () {
                        ...
                        if ($.inArray(extension, validFileExtensions) == -1) {
                            ...
                            if ($(this).get(0).files[0].size > (5000000)) {
                                $('#spnDocMsg').text("Sorry!! Max allowed file size is 5 Mb").show();
                                // Clear fileuload control selected file
                                $(this).replaceWith($(this).val('').clone(true));
                                //Disable Submit Button
                                //$('#btnSubmit').prop('disabled', true);
