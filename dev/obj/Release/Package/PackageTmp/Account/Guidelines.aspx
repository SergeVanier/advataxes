<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Guidelines.aspx.vb" Inherits="Advataxes.Guidelines" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
      ...
      <div id="tabs" style="height:950px;">
			<ul>
				...
				<li id="taxDocListItem"><a href="#tab-taxDoc">Tax Documentation</a></li>
				<li id="yearendListItem"><a href="#tab-yearEnd">Year-End</a></li>
			</ul>
                                                ...
                                                <tr><td>
                                                    <div style="position:relative;left:20px;">
                                                        <table>
															...
															<tr><td>Check this option if the expense you're entering will be paid by the company on your behalf.</td></tr>
                        ...
                        <tr><td>
                            <div style="position:relative;left:20px;">
                                <table>
                                    ...
                                    <tr><td>Once the review of a submitted expense report is completed, you can proceed with the approval process. Clicking on <img src="../images/finalize.png" width="15px" height="15px" /> will approve the report.</td></tr>
            ...
            <div id="tab-admin">
                <div style="position:relative;top:20px;left:20px; overflow:auto; height:870px; width:98%;">
                    <table width="96%">
                        ...
                        <tr><td>
                            <div style="position:relative;left:20px;">
                                <table>
									...
									<tr><td style="color:#cd1e1e;">Delegate</td></tr>
									<tr><td>The admin can delegate to an employee the task of filling out employees expenses of other employees. Users who are delegates can create reports, add expenses and submit reports on behalf of their coworkers.  Delegates need only to click on the drop-down menu in the My Expenses tab and select the right employee.</td></tr>
                                    
                                    <tr><td style="color:#cd1e1e;">Email</td></tr>
                                    <tr><td>Employee's email.</td></tr>
                                    ...
                                    <tr><td>Only administrators can view the information provided in the “Admin” tab. An administrator is allowed to proceed with a certain number of modifications in their profile. </td></tr>
									<tr><td style="color:#cd1e1e;">Approver status</td></tr>
                                    <tr><td>An approver will be in charge of reviewing employee expense reports. Once an employee is created, an e-mail is sent to him and he can proceed with the set-up of his account. For employees that no longer work for the organization, click on <img src="../images/checked.png" width="20px" height="20px" /> under Active to deactivate his account. He will no longer have access to Advataxes. </td></tr>									
                                    
                                    <tr><td style="color:#cd1e1e;">Notify by email</td></tr>
                                    <tr><td>If selected, the employee will be notified by email whenever an expense report has been finalized for all employees of his/her organization. Included in the email will be the amount that is owed to the employee. Usually, the person that is in charge of reimbursing employees will be the one to receive this notification.</td></tr>
                        ...
                        <tr><td>The reports sections provide a list of reports for GST-HST-QST, accounting and managerial purposes. </td></tr>
                        ...
                        <tr><td>When you go to the dashboard, you will see a list of employees and their last logged in date. When creating a new employee, the creation date will be set as the inital log in date.<br /><br /><br /></td></tr>
                        <tr><td>Should you have any questions, <a href="contactus.aspx" style="color:#cd1e1e">contact us</a> and one of our representatives will get back to you.</td></tr>
			...
			<div id="tab-taxDoc">
				<div style="position:relative;top:20px;left:20px; overflow:auto; height:870px; width:98%;">
					...
					<table width="96%">
						<tr style="height:40px;"><td valign="top" style="color:#cd1e1e; font-size:1.5em;">Tax Documentation</td></tr>
						<tr style="height:0.1px; background-color:#cd1e1e;"><td></td></tr>
						<tr><td style="height:10px;"></td></tr>

						<tr style="background-color:#cd1e1e;color:white;"><td><b>Federal Government</b></td></tr>
						<tr style="height:10px;"><td></td></tr>
						
						<tr><td><a href="#" onclick="javascript:window.open('http://laws-lois.justice.gc.ca/eng/acts/E-15/page-1.html');" style="color:#cd1e1e;"><u>Excise Tax Act</u></a></td></tr>
						
						<tr><td><a href="#" onclick="javascript:window.open('http://www
u></a></td></tr> 
						
						<tr><td><a href="#" onclick="javascript:window.open('http://www2.publicationsduquebec.gouv.qc.ca/dynamicSearch/telecharge.php?type=16&file=T0_1A206_1T8BULB.pdf');" style="color:#cd1e1e;"><u>TVQ.206.1-8: Input Tax Refunds in Respect of Gasoline Used by Large Businesses</u></a></td></tr> 
						
						<tr><td><a href="#" onclick="javascript:window.open('http://www2.publicationsduquebec.gouv.qc.ca/dynamicSearch/telecharge.php?type=16&file=T0_1A206_1T9BULB.pdf');" style="color:#cd1e1e;"><u>TVQ.206-1-9: Qualification as a small or a medium sized business or as a large business</u></a></td></tr> 
						
						<tr><td><a href="#" onclick="javascript:window.open('http://www2.publicationsduquebec.gouv.qc.ca/dynamicSearch/telecharge.php?type=16&file=T0_1A211T3R3BULB.pdf');" style="color:#cd1e1e;"><u>TVQ.211-3/R3: Input tax refund in respect of expense allowances</u></a></td></tr>
						
						<tr><td><a href="#" onclick="javascript:window.open('http://www2.publicationsduquebec.gouv.qc.ca/dynamicSearch/telecharge.php?type=16&file=T0_1A457_1T1BULB.pdf');" style="color:#cd1e1e;"><u>TVQ.457.1: Entertainment Expenses </u></a></td></tr> 
						
						<tr><td><a href="#" onclick="javascript:window.open('http://www2.publicationsduquebec.gouv.qc.ca/dynamicSearch/telecharge.php?type=16&file=I3A37T2R2BULB.pdf');" style="color:#cd1e1e;"><u>IMP-37-2/R2: Payment or reimbursement by an employer of the amounts to be paid by an employer as a member of a professional association</u></a></td></tr> 
						
						<tr><td><a href="#" onclick="javascript:window.open('http://www.revenuquebec.ca/en/citoyen/taxes/tpstvq/transport/hors_quebec/tvq.aspx');" style="color:#cd1e1e;"><u>Application to the QST to Passenger Transportation Outside Québec</u></a></td></tr> 
						
						<tr><td><a href="#" onclick="javascript:window.open('http://www.revenuquebec.ca/en/entreprise/taxes/tvq_tps/perception/cas_particuliers/transport/hors_quebec/tps.aspx');" style="color:#cd1e1e;"><u>Application to the GST to Passenger Transportation Outside Québec</u></a></td></tr> 
												
						<tr style="height:20px;"><td></td></tr>
						<tr style="background-color:#cd1e1e;color:white;"><td><b>Prince Edward Island Government</b></td></tr>	
						<tr style="height:10px;"><td></td></tr>
			...
			<div id="tab-yearEnd">
				<div style="position:relative;top:20px;left:20px; overflow:auto; height:870px; width:98%;">
					...
					<table width="96%">
						<tr style="height:40px;"><td valign="top" style="color:#cd1e1e; font-size:1.5em;">Year-end</td></tr>
						<tr style="height:0.1px; background-color:#cd1e1e;"><td></td></tr>
						<tr><td style="height:10px;"></td></tr>
					
					<tr><td>The software is structured so the administrator can extract the relevant information and perform year-end GST-HST-QST adjustments on several categories of expenses, as the case may be.</td></tr> 
					<tr><td></td></tr>
					<tr><td style="color:#cd1e1e; font-weight:bold; font-size: 15px">Functionality to obtain Specific Reports for GST-HST-QST Purposes</td></tr>
					<tr><td>Within the “Admin” section, go to the “Report” tab.  You may select “custom” in the “report range” field and select the desired range (e.g. Jan 1, 2012, to December 31, 2012).</td></tr> 
					<tr><td>In the report type, you can select “Summary by Category” and then select again within the “Category field” your chosen category.  You will then view posted amounts, employees name, posted periods, the invoices relating to this particular category of expense if it has been uploaded by the employee for the selected date range.</td></tr> 
					<tr><td></td></tr>
					<tr><td style="color:#cd1e1e; font-weight:bold; font-size:15px">Managing GST-HST-QST and More</td></tr>
					<tr><td>This wide variety of reports can be used to manage GST-HST-QST for year-end adjustments for the following situations:</td></tr>
					<tr><td></td></tr>
					<tr><td style="color:#cd1e1e; font-weight:bold;">Vehicle expenses</td></tr>
					<tr><td>There are several tax rules relating to the use of vehicles by employees for both business purposes and personal purposes based on employees’ kilometer logs. Tax consequences may impact the following categories of expenses:</td></tr>
					<tr><td>
					<ul>
						<li>Car & truck repairs</li>
						<li>Car rental (long term)</li>
						<li>Gas for cars</li>
					</ul>	
					</td></tr>
					<tr><td>See <a href="#" onclick="javascript:window.open('http://www.cra-arc.gc.ca/E/pub/tg/t4130/');" style="color:#cd1e1e;"><u>T4130 Employers' Guide - Taxable Benefits and Allowances</u></a> and <a href="#" onclick="javascript:window.open('http://www.cra-arc.gc.ca/E/pub/gm/8-2/8-2-e.pdf');" style="color:#cd1e1e;"><u>GST/HST Memorandum 8.2 General Restrictions and Limitations</u></a> for further details.</td></tr>
					<tr><td>All reports listing expenses can also be obtained by Division (e.g. Marketing), or by employees for any given period of time.</td></tr>
					<tr><td></td></tr>
					<tr><td style="color:#cd1e1e; font-weight:bold;">Expenses for Personal use</td></tr>
					<tr><td>There is an administrative rule that allows registrants to claim input on expenses that are for personal use with a threshold of up to $500 per year. Although the software does not automate this rule, by having a separate category for this type of expense, you can obtain the list of these expenses that have been posted within this accounting software and proceed as the case may be with a tax recovery on these expenditure. You can obtain details on this rule within the <a href="#" onclick="javascript:window.open('http://www.cra-arc.gc.ca/E/pub/gm/8-2/README.html');" style="color:#cd1e1e;"><u>GST/HST Memoranda 8.2 General Restrictions and Limitations</u></a>.</td></tr>
					<tr><td></td></tr>
					<tr><td style="color:#cd1e1e;font-weight:bold;">Relocation allowance</td></tr>
					<tr><td>CRA's policy is to the effect that moving allowances reimbursed to an employee for up to $650 can give rise to an input tax. Revenu Quebec considers that a moving allowance representing up to two weeks’ pay is acceptable for QST purposes. For more information, consult <a href="#" onclick="javascript:window.open('http://www.cra-arc.gc.ca/E/pub/gr/news54/README.html');" style="color:#cd1e1e;"><u>GST/HST News 54</u></a>. As the software does not automate the calculation of input tax on these allowances, you can extract all these posting and proceed with GST, HST and QST adjustments, as the case may be.</td></tr>
					<tr><td style="color:#cd1e1e;font-weight:bold;">KM allowance and RITC in ON & BC</td></tr>
					<tr><td>For large businesses who have recapture of input tax credits on this expense, you should know Finance Canada is in discussion with BC and Ontario on the creation of an administrative factor on Auto allowances. This factor would recover taxes on aspects of the kilometer allowance not classified as specified property or services, such as repair and maintenance. This information has been reported within <a href="#" onclick="javascript:window.open('http://www.tei.org/news/Documents/TEI%20CCTC-CRA-Finance%20Liaison%20Agenda.pdf');" style="color:#cd1e1e;"><u>TAX EXECUTIVES INSTITUTE, INC.  EXCISE TAX QUESTIONS  Submitted to  CANADA REVENUE AGENCY and  THE DEPARTMENT OF FINANCE DECEMBER 4-5, 2012</u></a>. <u>Periodic</u> RITC adjustment may be necessary. You should note that we are waiting that fiscal authorities release detailed guidelines on this matter. </td></tr>
