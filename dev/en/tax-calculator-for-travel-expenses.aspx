  ...
  <body>
    ...
    <div style="width:65%; margin:0 auto;">
        <table border=0 width="100%" style=" border-collapse:collapse;height:50px;">
            ...
            <tr valign="top" style="height:10px;"><td colspan="3"><span style="color:red; font-size:1.1em;">Advataxes automates the QST input recoveries at the rate of 25% for large businesses on restricted input tax refund for the period of January 1<sup>st</sup>, 2018 to December 31, 2018. For more details on this tax change please consult the article "<a href="https://blog.advataxes.ca/qst-phasing-out-the-restricted-itr-starting-on-january-2018/">QST Phasing out the Restricted ITR Starting on January 1, 2018</a>".</span><br><br></td></tr>
            <tr valign="top" style="height:10px;"><td colspan="3"><span style="color:red; font-size:1.1em;">Take into consideration the lowering of RITC in Ontario to 25% from July 1<sup>st</sup> 2017 to June 30<sup>th</sup> 2018 on specified properties and services for large businesses.<a. </span></td></tr>
        </table>
		<br />    
            ...
            <tr>
                ...
                <div style=" padding:10px; background-color:#E6E3E3;border-radius:8px;">
                    ...
                    <table width="100%" style="font-size:1.2em; border-collapse:collapse;">
                            ...
                            <tr><td colspan="2"><a href="/en/images/tax-calculator-report-en 2.png" class="openReport"><img src="/en/images/tax-calculator-report-en 2.png" width="100%" style=" border:solid thin silver;border-radius:5px;" /></a></td></tr>
                    </table>  
