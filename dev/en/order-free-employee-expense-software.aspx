...
<head>
	<meta charset="utf-8">
	<title>Subscribe to the free travel expense software for one employee | Advataxes</title>
	<meta name="description" content="Subscribe to the free travel expense software for one employee">
	...
	<script runat="server" language="vb">
		Sub btnSend_Click(sender As Object, e As EventArgs)
			...
			returnValue = sendEmail(Me.txtEmail.Text, "Advataxes - Free version - " & txtName.Text, message)
	...
	<div class="container container-top">
		<div class="row">
			<div class="col-md-12 center">
				<h1>Subscribe to the free travel expense software for one employee</h1>
			</div>
		</div><!-- end row -->
	</div><!-- end container -->
