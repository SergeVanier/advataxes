            ...
            <div id="divSaveExpense" style="left:130px;top:-20px;width:95%">
                <table width="100%">
                    <tr>
                        <td>&nbsp;</td>
                        <td align="right" >                            
                            <asp:Button ID="cmdSaveExpense" runat="server" Text="140" height="30px" tooltip="Save and close" width="60px" CausesValidation="true" ValidationGroup="NewExpense" CssClass="button2"  />
                ...
                <script type="text/javascript">
                    ...
                    $(document).ready(function () {
                        ...
                        function setPnlCreateExpenseTop() {
                            setTimeout(function () {
                                //console.log('loop to adjust pnlCreateExpense top.');
                                if (pnlCreateExpense.is(':visible')) {
                                    //console.log('pnlCreateExpense is visible, adjusting top to : ' + (windowHeight - pnlCreateExpense.height()) / 2);
