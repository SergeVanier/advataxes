<%@ Page Language="vb" MasterPageFile="~/Site.Master"  AutoEventWireup="true" CodeBehind="Reports.aspx.vb" Inherits="Advataxes.Reports" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server"  > 
        ...
        <link href="/css/tourist.css?v1" rel="stylesheet" type="text/css" />
        
        <asp:ScriptManager id="ScriptManager1" runat="server" /> 

 	    <div id="msg" class="ui-widget">
		    <div class="ui-state-highlight ui-corner-all" style="margin-top: 20px; padding: 0 .7em;"> 
			    <p><span class="ui-icon ui-icon-info" style="float:left; margin:3px 5px 0;"></span>
        ...
        <tr>
            ...
            <td class="style11" valign="middle">
                ...
                <a id="btnNewReport" href="#" class="newRpt" title="<%=hdnAddReportTooltip.value %>"  ><img src="/images/new.png" /></a>
            ...
            <td>                
                <%If Not Me.isSubmitted Then%>
                    <span class="labelText"><asp:Label ID="lbl69" runat="server" Text="Reports for:" Visible="true" Font-Size="Small"  ></asp:Label></span>
                    <asp:DropDownList ID="cboDelegate" runat="server" AutoPostBack="True" DataSourceID="sqlDelegate" DataTextField="Name" AppendDataBoundItems="true" DataValueField="EMP_ID" Width="170px" Visible="true"  />
                        
                <%Else%>
                        <span class="labelText"><asp:Label ID="lbl73" runat="server" Text="Employee:" Visible="false" Font-Size="Small"  ></asp:Label></span>
                        <asp:DropDownList ID="cboEmp" runat="server" AutoPostBack="True" DataSourceID="sqlListOfEmployeesBySupervisor" DataTextField="Name" AppendDataBoundItems="true" DataValueField="EMP_ID" Width="170px" Visible="false"  >
    ...
    <div>
        <asp:GridView ID="gridViewReports" runat="server"
            ...
            <Columns>
                ...
                <asp:TemplateField ItemStyle-Width="15px" ItemStyle-ForeColor="Black" >
                    ...
                    <ItemTemplate><a href="#" id='<%# Eval("REPORT_ID") %>' class="editRpt" title="<%=hdnEditTooltip.value %>"> <%# IIf(Eval("STATUS_ID") = 1 OrElse (Eval("STATUS_ID") = 2 AndAlso Not IsNothing(Request.QueryString("submitted")) AndAlso Request.QueryString("submitted") = 1), "<img  border='0' src='/images/edit.png' alt='Edit' />", "")%></a></ItemTemplate>
                </asp:TemplateField>
        ...
        <table>
            <tr>
                ...
                <td id="Cell-NewExp">&nbsp;&nbsp;<a id="cmdNewExp" href="#" class="newExp"><img style="vertical-align:middle;" src="/images/new.png"  title="<%=hdnAddExpTooltip.value %>" /></a></td>
                <td id="Cell-ReportTitle" style="color:#cd1e1e; font-size:x-large;">&nbsp;&nbsp;<asp:Label runat="server" ID="labelReportName"></asp:Label></td>
                <td></td>
            </tr>
        </table>
                   ...
                   <asp:TemplateField  ItemStyle-Width="10px">
                    ...
                    <asp:TemplateField HeaderText="63"  ItemStyle-Width="100px"  ItemStyle-ForeColor="black" ItemStyle-HorizontalAlign="Right">
                       <%-- <ItemTemplate><asp:Label ID="Label1" runat="server" Text='<%# IIf(New List(Of String)(New String() {"taxi", "meals & entertainment", "meals & entertainment*", "meals & entertainment (work site + 30 km from a 40k urban area)"}).Contains(Eval("CAT_NAME").ToString().ToLower()), IIf(Eval("GRATUITIES") = 0, IIf(Eval("RATE") < 1, FormatNumber(Eval("AMOUNT") / Eval("RATE"), 0) & " x " & FormatNumber(Eval("RATE"), 2), ""), FormatNumber(Eval("GRATUITIES"), 2)), "")  %>'></asp:Label></ItemTemplate>--%>
                        <ItemTemplate><asp:Label ID="Label1" runat="server" Text='<%#IIf(Eval("GRATUITIES") = 0 And Eval("CAT_ID") = 4, IIf(Eval("RATE") < 1, FormatNumber(Eval("AMOUNT") / Eval("RATE"), 0) & " x " & FormatNumber(Eval("RATE"), 2), ""), FormatNumber(Eval("GRATUITIES"), 2))  %>'></asp:Label></ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField  ItemStyle-Width="15px">
                        <ItemTemplate>
                             <% If Not cboStatus.SelectedValue = "Finalized" And Not(cboStatus.SelectedValue = "Pending Approval" Or cboStatus.SelectedValue = "Approved") Then%>
                            <a href="#" id='<%# Eval("EXPENSE_ID") %>' class="delExpense" title="<%=hdnDeleteRptTitle.value %>"><img  border='0' src='/images/del.png' alt='Delete' /></a>
                             <% ElseIf Request.QueryString("submitted") = 1 And (cboStatus.SelectedValue = "Pending Approval" Or cboStatus.SelectedValue = "Approved") Then%>
                            <a href="#" id='<%# Eval("EXPENSE_ID") %>' class="delExpense" title="<%=hdnDeleteRptTitle.value %>"><img  border='0' src='/images/del.png' alt='Delete' /></a>
                      <%end if %>
                        </ItemTemplate>
                    </asp:TemplateField>
...
<!---------------------------------------------------PANELS---------------------------------------------------------------->
        ...
        <table width="100%" border=0>               
            <tr><td colspan="2">File:<asp:FileUpload ID="FileUpload2" runat="server" Width="100%" size="40" /></td></tr>
        ...
        <table width="95%"><tr><td align="right"><br /><asp:Button ID="cmdAttachFile" runat="server" height="30px" width="100px" Text="Save" CausesValidation="true" ValidationGroup="Attach" /><asp:Button ID="cmdCancelAttach" runat="server" Text="Cancel" class="cancelAttach" UseSubmitBehavior="false" CssClass="button2" /></td></tr></table>
        ...
        <div style="margin:10px">
            ...
            <table width="60%">
                ...
                <tr><td colspan="10"><asp:Label ID="lbl74" runat="server" Text="Report Name:  " class="labelText" />
                                     <asp:TextBox ID="txtReportName" runat="server" Width="300px" MaxLength="30"></asp:TextBox>
                                     <br />
<br /><br /></td></tr>
                <tr><td align="right" colspan="10">
                    <asp:Button ID="cmdSaveReport" runat="server" class="button2" Text="140" CausesValidation="true" ValidationGroup="NewReport" OnClientClick="closeForm('modalCreateReport')" />
                    <input id="Button2" type="button" value="<%= hdnCancelText.value %>" class="cancelRpt button2" />
                </td></tr>
            </table>
        </div>
    </asp:Panel>
    
        <asp:Panel ID="pnlCreateExpense" runat="server" CssClass="modalPopup" DefaultButton="cmdSaveExpense" Width="600px" style="display:none;" >
        ...
        <div style="position:relative;left:15px;">
                    ...
                    <table width="95%" border=0>
                        ...
                        <tr id="Row-JurMsg">
                            ...
                            <tr  height="30px">
                                ...
                                <td width="50%">
                                    <asp:DropDownList ID="cboCat" class="cboCat" runat="server" DataSourceID="sqlGetActiveOrgCategories" DataTextField="CAT_NAME" DataValueField="ORG_CAT_ID" />                                                        
                            ...
                            <tr id="Row-TaxRate"  height="30px">
                                ...
                                <td><asp:DropDownList ID="cboTaxRate" runat="server"  DataSourceID="sqlGetAirTaxRates" DataTextField="TR_DESCRIPTION" DataValueField="JUR_ID" /></td>
                            </tr>
                            ...
                            <tr id="Row-Rate"  height="30px">
                                ...
                                <td>
                                    ...
                                    <asp:DropDownList ID="cboRate" runat="server"  ><asp:ListItem></asp:ListItem></asp:DropDownList>
                                </td>
                            </tr>
                            ...
                            <tr id="Row-Jur" height="30px">
                                ...
                                <td><asp:DropDownList ID="cboJur" runat="server" DataSourceID="sqlGetJurisdictions" DataTextField="JUR_NAME" DataValueField="JUR_ID" Width="214px" /></td>
                            </tr>
                            ...
                            <tr id="Row-Amt" height="10px">
                                ...
                                <td>
                                    ...
                                    <asp:DropDownList ID="cboTaxIE" runat="server" >
                                        <asp:ListItem Value="1">Tax Included</asp:ListItem>
                                        <asp:ListItem Value="2">Before Tax</asp:ListItem>
                                    </asp:DropDownList>
                                    
                                    <asp:DropDownList ID="cboCurr" runat="server" DataSourceID="sqlGetCurrenciesSome" DataTextField="CURRENCY" DataValueField="CURR_ID">
                                    </asp:DropDownList>
                            ...
                            <tr id="Row-Grat" height="30px">
                                ...
                                <td valign="middle"><asp:TextBox ID="txtGrat" runat="server" class="numberinput" />&nbsp;&nbsp;<a id="24" href="#" class="popUpWin"><img style="vertical-align:middle" src="/images/question.png" width="18px" height="18px" /></a></td>
                            </tr>
                            ...
                            <tr id="Row-DontReimburse">
                                ...
                                <td class="labelText">
                                   <label class="checkboxText">
                                      <asp:CheckBox ID="chkDontReimburse" runat="server" /><asp:Label ID="lbl51" runat="server" Text="Do not reimburse"></asp:Label>
                                   </label>
                                   <a id="23" href="#" class="popUpWin"><img style="vertical-align:middle;" src="/images/question.png" width="17px" height="17px" /></a>
                                   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:DropDownList ID="cboTP" DataSourceID="sqlGetActiveTP" DataTextField="ACCOUNT" DataValueField="VENDOR_NUMBER" runat="server" />
                                </td>
                            </tr>
                            ...
                            <tr id="Row-Attendees" height="30px">
                                ...
                                <td><asp:TextBox ID="txtAttendees" runat="server" Width="95%" TextMode="MultiLine"  Font-Names="Arial"></asp:TextBox></td>
                            </tr>

                            <tr height="30px">
                                <td align="left" valign="top" ><asp:Label ID="lbl48" runat="server" Text="Comment:" class="labelText" /></td>
                                <td><asp:TextBox ID="txtComment" runat="server" Width="95%" TextMode="MultiLine" Font-Names="Arial" ></asp:TextBox></td>
                            </tr>
                            <tr><td></td></tr>
                            ...
                            <tr>
                                ...
                                <td valign="middle">
                                    <asp:FileUpload ID="FileUpload1" runat="server" /><asp:Label ID="lblSelectedReceipt" runat="server" CssClass="labelText"></asp:Label>
                            ...
                            <tr id="Row-GST">
                                <td align="left" valign="middle">
                                    <asp:Label ID="lbl50" runat="server" Text="GST/HST paid:" class="labelText" />
                                </td>
                                <td>
                                    <div>
                                    <asp:TextBox ID="txtGST" runat="server" Width="75px" BorderStyle="Solid" BorderWidth="1px" Enabled="false"  class="numberinput" style=" text-align:right;"></asp:TextBox><asp:Label ID="lblGST" runat="server" Text="" ForeColor="Red" Font-Bold="true"></asp:Label>
                                    &nbsp;&nbsp;&nbsp;
                                    <a href="#">
                                        <img id="imgUnlockGST" src="/images/lock.png" title="Unlock Field" class="unlockGST" width="12px" height="16px" />
                                    </a>
                                    &nbsp;&nbsp;
                                    <a id="367" href="#" class="popUpWin">
                                        <img src="/images/question.png" width="17px" height="17px" style="visibility:hidden;" />
                                    </a>
                                    </div>
                                    <div>
                                        <asp:Label ID="validationError_GST" runat="server" Text="" Visible="false"></asp:Label>
                                    </div>
                                </td>
                            </tr>
                            <tr id="Row-HST">
                                <td align="left">
                                    <asp:Label ID="lblHSTpaid" runat="server" Text="HST paid:" class="labelText" />
                                </td>
                                <td>
                                    <asp:TextBox ID="txtHST" runat="server" Width="75px" BorderStyle="Solid" BorderWidth="1px" Enabled="true"  class="numberinput" style=" text-align:right;"></asp:TextBox>
                                    <asp:Label ID="lblHST" runat="server" Text=""></asp:Label>
                                </td>
                            </tr>
                            <tr id="Row-QST">
                                <td align="left" valign="middle">
                                    <asp:Label ID="lbl66" runat="server" Text="QST paid:" class="labelText" />
                                </td>
                                <td>
                                    <div>
                                        <asp:TextBox ID="txtQST" runat="server" Width="75px" BorderStyle="Solid" BorderWidth="1px" Enabled="false" ForeColor="Black"  class="numberinput" style=" text-align:right;"></asp:TextBox>
                                        <asp:Label ID="lblQST" runat="server" Text=""></asp:Label>
                                        &nbsp;&nbsp;&nbsp;
                                        <a href="#">
                                            <img id="imgUnlockQST" src="/images/lock.png" title="Unlock Field" class="unlockQST"  width="12px" height="16px"/>
                                        </a>
                                        &nbsp;&nbsp;
                                        <a id="367" href="#" class="popUpWin" style="display:none;">
                                            <img src="/images/question.png" width="17px" height="17px" />
                                        </a>
                                    </div>
                                    <div>
                                        <asp:Label ID="validationError_QST" runat="server" Text="" Visible="false"></asp:Label>
                                    </div>
                                </td>
                            </tr>
                            <tr id="Row-Total" >
                                <td align="left" valign="middle" style="  font-size:larger ; color:Green;">
                                    <asp:Label ID="lbl67" runat="server" Text="Total paid:" class="labelText" />
                                </td>
                                <td>
                                    <asp:TextBox  ID="txtTotal" runat="server" Width="75px" BorderStyle="Solid" BorderWidth="1px" Enabled="false" ForeColor="Green" style=" text-align:right;" />
                                    <div id="exceedMsg" style="position:relative;top:-23px;left:85px;background-color:#cd1e1e;color:White;width:225px;border-radius:3px;text-align:center;">
                                        <asp:Label ID="lbl446" runat="server" Text="Total amount exceeds allowed limit"></asp:Label>
                                    </div>
                                    <div>
                                        <asp:Label ID="valdiationError_Amount" runat="server" Text="" Visible="false"></asp:Label>
                                    </div>
                                </td>
                            </tr>
                        </table>                
            ...
            <div id="divSaveExpense" style="left:130px;top:-20px;width:95%">
                <table width="100%">
                    <tr>
                        <td>&nbsp;</td>
                        <td align="right" >                            
                            <asp:Button ID="cmdSaveExpense" runat="server" Text="140" tooltip="Save and close" CausesValidation="true" ValidationGroup="NewExpense" CssClass="button2"  />
                            <asp:Button ID="cmdSaveExpense2" runat="server" Text="141" ToolTip="Save and add another expense"  CausesValidation="true" ValidationGroup="NewExpense"  CssClass="button2"  OnClientClick="closeForm('modalCreateExpense')"  />
                            <asp:Button ID="cmdCancel" runat="server" Text="142" UseSubmitBehavior="false" CssClass="button2 cancelExp" />
                        </td>
                    </tr>
             <!--  <caption>
                        cancel</caption> -->
...
<!-----------------------------------------------HIDDEN FIELDS------------------------------------------------------------------->
    ...
    <asp:HiddenField id="hdnAddReportTooltip" runat="server" />
...
<!-----------------------------------------------DATA SOURCES------------------------------------------------------------------->
            ...
            <asp:SqlDataSource ID="sqlReportsByEmpID" runat="server" 
                 ...
                 <SelectParameters>
                     <asp:ControlParameter ControlID="cboDelegate" DefaultValue="0" Name="EmpID" PropertyName="SelectedValue" Type="Int32" />
                 </SelectParameters>
            ...
            <asp:SqlDataSource ID="sqlGetCurrenciesSome" runat="server" 
                ConnectionString="<%$ ConnectionStrings:dbadvaloremConnStr %>" 
    ...
    <table><tr id="dummytable"><td><asp:Button ID="cmdDummy" runat="server" Text="Button"  /></td></tr></table>
                <script type="text/javascript">
                    ...
                    $(document).ready(function () {
                        ...
                        var pnlCreateExpense = $("#<%=pnlCreateExpense.ClientID %>");
                        //cross-browser compatible way to get the clientHeight
                        var windowHeight = window.innerHeight || document.documentElement.clientHeight || document.body.clientHeight;

                        //lets start a timer that will automatically adjust the top of the modal popup for createExpense based on its height
                        function setPnlCreateExpenseTop() {
                            setTimeout(function () {
                                if (pnlCreateExpense.is(':visible')) {
                                    //so how high exactly is the popup, and how high exactly is the screen, we'll put top = document.clientHeight - pnlCreateExpense.Height / 2
                                    pnlCreateExpense.css('top', (windowHeight - pnlCreateExpense.height()) / 2);
                                }
                                setPnlCreateExpenseTop();
                            }, 50);
                        }

                        setPnlCreateExpenseTop();

                        //until support for image preview is fixed we will remove the hook
                        ...
                        if (getQuerystring('rID', '0') != '0') pnlCreateExpense.css('left', -100);
                        ...
                        if (getQuerystring('rID', '0') != '0') {
                            var receiptID = getQuerystring('rID', '0');
                            var puk = $("#<%=hdnPUK.ClientID %>").val();

                            $.ajax({
                                type: "POST",
                                url: "reports.aspx/CheckReceiptNum",
                                data: "{'rID': '" + receiptID + "','puk': '" + puk + "'}",
                                contentType: "application/json; charset=utf-8",
                                dataType: "json",
                                success: function (returnVal) {
                                    $("#<%=hdnSelectedReceipt.ClientID %>").val(receiptID);
                                    $("#<%=FileUpload1.ClientID %>").hide();
                                    $("#<%=lblSelectedReceipt.ClientID %>").text("Receipt #" + receiptID);
                                },
                                error: function () {
                        ...
                        //$("#<%=cboCurr.ClientID %>").prop('selectedIndex', 'CAD');
                        ...
                        if ($("#<%= hdnOpenReport.ClientID %>").val() == "True") {
                            ...
                            if (getQuerystring('submitted', '0') !== '1') {
                                ...
                                if ($("#<%= cboStatus.ClientID %>").val() == "Open") {
                                    ...
                                    else if ($("#<%=gridViewExpenses.ClientID %> tr").length = 25) $("#Cell-NewExp").hide();
                                }                              
                                else {
                                    $("#btnSubmit").hide();
                                    $("#Cell-NewExp").hide();
                        ...
                        $("#<%=txtGrat.ClientID %>").blur(function () {
                            if ($("#<%=txtTotal.ClientID %>").val() == "NaN") {
                                alert("You entered an invalid amount");
                                $("#<%=cmdSaveExpense.ClientID %>").prop("disabled", "disabled");
                                $("#<%=cmdSaveExpense2.ClientID %>").prop("disabled", "disabled");
                        ...
                        $("#<%=txtGST.ClientID %>").blur(function () {
                            if (!$.isNumeric($("#<%=txtGST.ClientID %>").val())) {
                                alert("You entered an invalid amount");
                                $("#<%=cmdSaveExpense.ClientID %>").prop("disabled", "disabled");
                                $("#<%=cmdSaveExpense2.ClientID %>").prop("disabled", "disabled");
                            } else {
                        ...
                        $("#<%=txtQST.ClientID %>").blur(function () {
                            if (!$.isNumeric($("#<%=txtQST.ClientID %>").val())) {
                                alert("You entered an invalid amount");
                                $("#<%=cmdSaveExpense.ClientID %>").prop("disabled", "disabled");
                                $("#<%=cmdSaveExpense2.ClientID %>").prop("disabled", "disabled");
                            } else {
                        ...
                        $("#<%=cboJur.ClientID %>").change(function () {
                            // Remove focus on the Amount field
                            $("#<%=txtAmt.ClientID %>").keyup();

                            // Show a warning msg, if CAD and "Outside Canada"
                            // or if currency not CAD and not "Outside Canada"
                            if ( ( $("#<%=cboCurr.ClientID %> :selected").val() == '25' && $("#<%=cboJur.ClientID %>").val() == '14') ||
                                 ( $("#<%=cboCurr.ClientID %> :selected").val() != '25' && $("#<%=cboJur.ClientID %>").val() != '14') )  {
                            ...
                            if (org_cat_id != '') {
                                ...
                                $.ajax({
                                    ...
                                    success: function (returnVal) {
                                        ...
                                        if (isFirefox) {
                                            if (Allows["CategoryID"] == "20" || Allows["CategoryID"] == "38")
                                                $("#divSaveExpense").css("left", "-400px");
                                        }
                                        ...
                                        if (Allows["CategoryID"] == "44") {
                                            ...
                                            $("#ExpMsg").css("height", "35");
                                            $("#Row-ExpMsg").fadeIn(300);
                                            if (isFirefox) $("#divSaveExpense").css("left", "-400px");
                        ...
                        $(".editExp").click(function () {
                            ...
                            $.ajax({
                                ...
                                success: function (msg) {
                                    ...
                                    if (expense["AllowGratuity"] == 'True') $("#Row-Grat").show(); else $("#Row-Grat").hide();
                                ...
                                function () {
                                    ...
                                    $.ajax({
                                        ...
                                        success: function (val) {
                                            ...
                                            else if ($("#<%=gridViewExpenses.ClientID %> tr").length = 25)
                                            {
                                                $("#Cell-NewExp").show();
                                            }
                                           else
                        ...
                        $(".cancelExp").mousedown(function () {
							...
							if (getQuerystring('ce', 0) == 1) window.location = 'reports.aspx';
                            var mpe = $find('modalCreateExpense');
                            if (mpe) { mpe.hide(); }
                            ...
                            if (input.files && input.files[0]) {
                                ...
                                if (extension === "jpg" || extension === "png" || extension === "gif") {
                                    ...
                                    if (!$('.rightColumn').is(':visible')) {
                                        pnlCreateExpense.animate({ width: '850px' }, 500);
                                    ...
                                    if ($('.rightColumn').is(':visible')) {
                                        ...
                                        $('.rightColumn').hide();
                                        pnlCreateExpense.animate({ width: '600px' }, 500);
...
<asp:Content ID="Content2" runat="server" contentplaceholderid="head">
    ...
    <style type="text/css">
        .style9 { font-family: Arial, Helvetica, sans-serif; font-size: x-large; font-weight: bold; color: #black; }
